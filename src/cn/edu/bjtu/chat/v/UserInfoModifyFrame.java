...
public class UserInfoModifyFrame extends JFrame {
	...
	public UserInfoModifyFrame(Socket s,UserInfo u) {
		super();
		this.s = s;
		this.u = u;
		initialize();
...
//								u.setInfo(textField_info.getText().trim());
		...
		button_1.setBounds(107, 388, 70, 23);
		...
		button_2.setBounds(204, 388, 70, 23);
		jContentPane.add(button_2);
